...
import com.xiaoma.mzrightbar.rightbar.FavoriteActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int FAVORITE_CODE = 0x13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(MainActivity.this, FavoriteActivity.class), FAVORITE_CODE);
            }
        });
